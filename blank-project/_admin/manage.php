...
$sql = "SELECT id,title,structure,extrasql_on_view,save_for_later FROM " . STRUCTURE_TABLE_NAME . " WHERE live='Yes' AND slug='" . $table . "' LIMIT 0,1";
$result = suQuery($sql);
...
$sqlFrom = " FROM " . $table . " WHERE live='Yes' $extrasqlOnView ";
            ...
            <div class="row">
                <main>
                    <div class="col-sm-10 content-area">
                        ...
                        <?php
                        //Any actions desired at this point should be coded in this file
                        if (file_exists('includes/specific/manage-pre.php')) {
                            include('includes/specific/manage-pre.php');
                        }
                        ?>
                        <?php
