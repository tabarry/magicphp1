...
if ($do == 'login') {
    ...
    $sql = "SELECT id, " . suJsonExtract('data', 'name') . "," . suJsonExtract('data', 'email') . "," . suJsonExtract('data', 'photo') . "," . suJsonExtract('data', 'theme') . "," . suJsonExtract('data', 'user_group') . " FROM " . USERS_TABLE_NAME . " WHERE " . suJsonExtract('data', 'email', FALSE) . "='" . suStrip($_POST['email']) . "' AND " . suJsonExtract('data', 'password', FALSE) . "='" . suCrypt(suStrip($_POST['password'])) . "' AND " . suJsonExtract('data', 'status', FALSE) . "='" . suStrip('Active') . "'";
